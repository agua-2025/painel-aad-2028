    ...
    <ProtectedArea>
      <div className="rounded-[2rem] bg-[#13233a] p-6 text-white shadow-xl shadow-slate-900/10 md:p-8">
        ...
        <p className="mt-4 max-w-3xl leading-7 text-white/75">
          Canal de orientação para dúvidas sobre associação, cadastro, pagamentos
          e participação.
        </p>
      </div>
      ...
      <div className="mt-8 rounded-3xl border border-[#e8dccb] bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-black tracking-[-0.04em]">
          Atendimento pela Secretaria/Diretoria
        </h2>

        <p className="mt-3 leading-7 text-[#596579]">
          Em breve este espaço terá orientações de contato e acompanhamento de
